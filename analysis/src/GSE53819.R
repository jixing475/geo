...
gsms <- "000000000000000000111111111111111111"
...
# par(mar=c(7,4,2,1))
# title <- paste ("GSE53819", "/", annotation(gset), sep ="")
...
par(mar=c(4,4,2,1))
title <- paste ("GSE53819", "/", annotation(gset), " value distribution", sep ="")
...
plotSA(fit2, main="Mean variance trend, GSE53819")
